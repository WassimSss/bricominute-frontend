...
const ProScreen = () => {
    ...
    const fetchOrderLocation = async () => {
        ...
        try {
            ...
            console.error('Une erreur s\'est produite lors de la récupération des coordonnées de l\'adresse de la commande :', error);
            return null;
        }
    };
        ...
        <View style={styles.container}>
            ...
            <View style={styles.containerMoneyInfo}>
                <TouchableOpacity style={styles.moneyInfo}>
                    <Text style={styles.text}>0.00<Text style={{ color: '#786396' }}>€</Text></Text>
                </TouchableOpacity>
            </View>
                ...
                <View style={styles.userContainer}>
                    ...
                    <View style={styles.textAndStar}>
                        ...
                        <View style={styles.starContainer}>
                            <Text style={styles.star}><FontAwesome name='star' size={20} color='#786396' /></Text>
                            <Text style={styles.star}><FontAwesome name='star' size={20} color='#786396' /></Text>
                            <Text style={styles.star}><FontAwesome name='star' size={20} color='#786396' /></Text>
                            <Text style={styles.star}><FontAwesome name='star' size={20} color='#786396' /></Text>
                            <Text style={styles.star}><FontAwesome name='star' size={20} color='#000000' /></Text>
                        </View>
                    </View>
                </View>
            ...
            <View style={styles.footer}>
                ...
                <Text style={styles.text}>Distance : {distanceFromTheServiceInKm !== null && distanceFromTheServiceInKm}</Text>
            </View>
